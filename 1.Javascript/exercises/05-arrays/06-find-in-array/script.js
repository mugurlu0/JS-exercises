...
(() => {
    document.getElementById("run").addEventListener("click", () => {
        ...
        ];const resultat = people.find( person => person.firstname === 'Jean' && person.lastname === 'Dupont');
        console.log(resultat.email);
        console.log(people.indexOf(resultat));
    }); 
    
})();
// Affiche (dans la console) l'email de la personne dont le nom est "Dupont" et le prénom "Jean" dans le tableau people. Ensuite, affiche son index dans ce tableau.
